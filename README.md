...
Выпускник Магистр Университета Сириус по направлению **критической информационной инфраструктуры и информационной безопасности**. Пишу на C++, C#, Python и Java. Строю собственную распределённую инфраструктуру FoxInfra — серверы в Казани, Москве, Сочи и Нидерландах, связанные WireGuard mesh-сетью.
